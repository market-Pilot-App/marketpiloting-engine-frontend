...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  const showShell = !NO_SHELL.some((p) => pathname.startsWith(p)) && !pathname.startsWith("/p/") && !pathname.startsWith("/bio/") && !pathname.startsWith("/review/") && !pathname.startsWith("/report/") && !pathname.startsWith("/team/accept") && !pathname.startsWith("/offer/") && !pathname.startsWith("/auth/twitter/") && !pathname.startsWith("/auth/whatsapp/") && !pathname.startsWith("/auth/facebook/") && !pathname.startsWith("/auth/google-business/") && !pathname.startsWith("/sites/");
