...
export default function VideoQueuePage() {
  ...
  const isPlanAllowed = ["growth", "pro", "agency", "admin"].includes(client?.plan ?? "");
  ...
  if (!isPlanAllowed) {
    return (
      <div className="max-w-lg mx-auto mt-20 text-center">
        ...
        <h2 className="text-2xl font-bold text-white mb-2">Video Queue</h2>
        <p className="text-gray-400 mb-6">
          Video auto-scheduling is available on{" "}
    ...
    <div className="max-w-2xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-gray-400 text-sm mt-1">
          Upload a video → posts automatically to your platforms at the scheduled time
        </p>
      </div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <div className="relative group">
              <button disabled className="px-4 py-1.5 rounded-full text-sm font-medium capitalize bg-gray-800/50 text-gray-600 cursor-not-allowed">
                twitter
              </button>
        ...
        {platforms.includes("youtube") && (
          <div>
            <label className="text-sm text-gray-400 block mb-1">
              YouTube title <span className="text-gray-600">(optional)</span>
            </label>
            <input
              type="text"
              value={youtubeTitle}
              onChange={(e) => setYoutubeTitle(e.target.value)}
              placeholder="Enter a compelling YouTube title..."
              maxLength={100}
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-lg font-semibold text-white">Video Jobs</h2>
        ...
        {loadingJobs && jobs.length === 0 ? (
          ...
          <p className="text-gray-600 text-sm">No video jobs yet. Upload your first video above.</p>
        ) : (
